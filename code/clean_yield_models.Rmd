...
```{r}
marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), Coffee_Variety =c("Clone A", "Clone B", "Clone C", "Clone F", "Op1", "Op2") , grid_type = "counterfactual") -> datagrid_berrie_CLR
marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), grid_type = "counterfactual") -> datagrid_berrie_CLR2

marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), Coffee_Variety =c("Clone A", "Clone B", "Clone C", "Clone F", "Op1", "Op2") , grid_type = "counterfactual") -> datagrid_berrie_BES
marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), grid_type = "counterfactual") -> datagrid_berrie_BES2

marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), Coffee_Variety =c("Clone A", "Clone B", "Clone C", "Clone F", "Op1", "Op2") , grid_type = "counterfactual") -> datagrid_berrie_CWD
marginaleffects::datagrid(model = selected_berrie_model, CLR_leaf_incidence = c(0,0.20,0.40, 0.60, 0.80,1), grid_type = "counterfactual") -> datagrid_berrie_CWD2

### Estimate slope values for severities and  severities*Coffee_Variety

marginaleffects::avg_slopes(selected_berrie_model,
                            variables = "CLR_leaf_incidence",
                            by = "Coffee_Variety", newdata = datagrid_berrie_CLR) %>%
  as.data.frame %>%
  rename(factors = "Coffee_Variety") %>%
...
marginaleffects::avg_slopes(selected_berrie_model,
                            ...
                            by = "Coffee_Variety", newdata = datagrid_berrie_BES) %>%
  as.data.frame %>%
  rename(factors = "Coffee_Variety") %>%
...
marginaleffects::avg_slopes(selected_berrie_model,
                            ...
                            by = "Coffee_Variety", newdata = datagrid_berrie_CWD) %>%
  as.data.frame %>%
  rename(factors = "Coffee_Variety") %>%
...
marginaleffects::avg_slopes(selected_berrie_model, variables = "CWD_leaf_incidence",
                            newdata = datagrid_berrie_CWD2) %>%
  as.data.frame %>%
  mutate(type = "Disease leaf incidence alone",
         factors ="CWD") -> yield_trend_CWD

marginaleffects::avg_slopes(selected_berrie_model, variables = "CRBD_leaf_incidence", newdata = datagrid_berrie_BES2) %>%
  as.data.frame %>%
  mutate(type = "Disease leaf incidence alone",
...
get_significance_letters2(contrast_variety_df) %>%
